...
public class AssistantAgent extends ConversableAgent {
    ...
    private static final String DEFAULT_SYSTEM_MESSAGE =
            """
                    ...
                    If the result indicates there is an error, fix the error and output the code again. Suggest the full code instead of partial code or code changes. If the error can't be fixed or if the task is not solved even after the code is 