...
public class AssistantAgent extends ConversableAgent {
    ...
    private static final String DEFAULT_SYSTEM_MESSAGE =
            """
                    ...
                    When using code, you must indicate the script type in the code block. The user cannot provide any other feedback or perform any other action beyond executing the code you suggest. The user can't modify your co